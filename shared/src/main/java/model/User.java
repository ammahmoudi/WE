...
class User {
    ...
    @ManyToMany(mappedBy = "likes", cascade = {CascadeType.REFRESH})
    //@LazyCollection(LazyCollectionOption.FALSE)
    ...
    @ManyToMany(mappedBy = "followings", cascade = {CascadeType.REFRESH})
    //@LazyCollection(LazyCollectionOption.FALSE)
    private List <User> followers = new LinkedList <>();
    @ManyToMany(mappedBy = "seenList", cascade = {CascadeType.REFRESH})
    //@LazyCollection(LazyCollectionOption.FALSE)
    private List <Message> SeenMessages = new LinkedList <>();
    @ManyToMany(mappedBy = "userList", cascade = {CascadeType.REFRESH})
    //@LazyCollection(LazyCollectionOption.FALSE)
    ...
    @ManyToMany(mappedBy = "Blockeds")
    //@LazyCollection(LazyCollectionOption.FALSE)
    private List <User> Blockers = new LinkedList <>();
    @ManyToMany
    //@LazyCollection(LazyCollectionOption.FALSE)
    @JoinTable(name = "silents",
            joinColumns = {@JoinColumn(name = "silenter_id")},
            inverseJoinColumns = {@JoinColumn(name = "silented_id")})
    private List <User> silenteds = new LinkedList <>();
    @ManyToMany(mappedBy = "silenteds")
    //@LazyCollection(LazyCollectionOption.FALSE)
    ...
    //clientonly
    @Transient LastSeenPrivacy myOwnLastSeenPrivacy;
    @Transient String firstTimeToken;
